...
ROL_APP_MODPRY = [
    (0, 'Adminitrador del módulo proyectos', 'rol_adm_modpry'),
    (1, 'Adminitrador de evaluaciones de Proyectos', 'rol_adm_evapry'),
    (2, 'Administrador de marco logico', 'rol_adm_mlog'),
    (3, 'Administrador de productos y procesos de investigación', 'rol_adm_regppi'),
    (4, 'Administrador de programas', 'rol_adm_regpri'),
    (5, 'Administrador de proyectos', 'rol_adm_regpryi'),
    (6, 'Administrador de Diseño', 'rol_adm_regdisinv'),
    (7, 'Administrador de Gestion', 'rol_adm_reggespry')
