    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_usu_admin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'usui',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('id_usui', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App_regusui.usui')),
                ('ls_usu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('id_usui', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='App_regusui.usui')),
                ('rol_sis', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='App_modadm.rol')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('id_usui', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App_regusui.usui')),
                ('ls_pry_inv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App_regpryi.inf_pry')),
            ],
        ),
        migrations.CreateModel(
            name='rl_usui_prod',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('id_usui', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App_regusui.usui')),
                ('ls_prod_inv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App_regprgi.inf_prog_inv')),
            ],
        ),
        migrations.CreateModel(
