    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instit', models.CharField(blank=True, max_length=25, verbose_name='Nombre de la institucion ')),
                ('tipo_form', models.IntegerField(blank=True, choices=[(0, 'Universitaria'), (1, 'Especializacion'), (2, 'Maestría'), (3, 'Doctorado'), (4, 'PHD'), (5, 'Posdoctorado'), (6, 'Básica Secundaria'), (7, 'Básica Primaria'), (8, 'Diplomado'), (9, 'Curso Corto'), (10, 'Técnica'), (11, 'tecnológica'), (12, 'Curso libre')], default=0)),
                ('fch_ini', models.DateField(verbose_name='fecha de Inicio')),
                ('fch_fin', models.DateField(verbose_name='fecha de Fin')),
                ('certif', models.BooleanField(default=True, verbose_name='Posees Certificado')),
                ('nal', models.CharField(blank=True, max_length=20, null=True, verbose_name='Pais ')),
                ('ciudad', models.CharField(blank=True, max_length=20, null=True, verbose_name='Ciudad ')),
                ('mod', models.IntegerField(blank=True, choices=[(0, 'Presencial'), (1, 'Virtual'), (2, 'Semipresencial'), (3, 'A distancia'), (4, 'Aprendizaje Acompañado')], default=0, null=True)),
                ('tit', models.CharField(blank=True, max_length=20, null=True, verbose_name='Titulo obtenido ')),
                ('menc', models.CharField(blank=True, max_length=20, null=True, verbose_name='Mensión ')),
                ('token', models.CharField(blank=True, max_length=20, null=True, verbose_name='token de validación ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_red', models.CharField(max_length=30, verbose_name='Nombre de la red ')),
                ('usuario', models.CharField(max_length=20, verbose_name='nick o dirección de usuario')),
                ('url', models.URLField(verbose_name='Url de página principal dentro de la red.')),
                ('uso', models.IntegerField(blank=True, choices=[(0, 'frecuente'), (1, 'moderado'), (2, 'poco frecuente'), (3, 'inactivo')], default=0, null=True)),
