...
ROL_APP_USU = [
    (0, 'Usuario persona', 'rol_perusu'),
    (1, 'anonimo', 'rol_anmusu'),
...
class usu_inf_pers(models.Model):
    ...
    id = models.AutoField(primary_key = True)
    id_usu = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, null= True, blank=True)  # identificador de usuario
...
#ESTA NO ME PARECE YA
    id = models.AutoField(primary_key = True)
    id_usu = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, null= True, blank=True)   # identificador unico
