...
class param_config(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.titulo_param_config)
...
class rl_mod_param_cnf(models.Model): # relacion Listado de parámetro de configuración objetos de la clase param_config().
    ...
    class Meta:
        verbose_name = 'rl_mod_param_cnf'
        verbose_name_plural = 'rl_mod_param_cnfs'
...
class rl_app_mod_param_cnf(models.Model): # relacion Listado de parámetro de configuración objetos de la clase param_config().
    ...
    class Meta:
        verbose_name = 'rl_app_mod_param_cnf'
        verbose_name_plural = 'rl_app_mod_param_cnfs'
...
class fuente_ins(models.Model):
    ...
    log = models.CharField('lista de valores: ', max_length=100, null=False, blank = False)  # lista de valores: archivo,id app o mod, dir relativa
...
class rl_fuente_ins_param_cnf(models.Model): # Listado de parámetro de configuración objetos de la clase param_config().
    ...
    class Meta:
        verbose_name = 'rl_fuente_ins_param_cnf'
        verbose_name_plural = 'rl_fuente_ins_param_cnfs'
