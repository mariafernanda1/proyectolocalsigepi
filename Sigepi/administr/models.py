...
class rol(models.Model):
    ...
    tipo = models.IntegerField(null = False, blank = False, choices = TIPO_ROL, default = 0, max_length = 1) # Ver diccionario TIPO_ROL
...
class fuente_ins(models.Model):
    ...
    tipo = models.IntegerField(max_length=1, choices = TIPO_NUIP_CO, default = 0, null=False, blank = False)  # Tipo de fuente de inst. Externa, local, remota.
    tipo_arch = models.IntegerField(max_length=1, choices = TIPO_EXTEN, default = 0, null=False, blank = False) # Numerar las posibles extensiones del archivo de instalación 1=".zip";2=".gz",3=".deb";4=".exe"; etc)
...
class usu_inf_pers(models.Model):
    ...
    tipo_nuip = models.IntegerField(max_length=1, choices = TIPO_NUIP_CO, default = 0, null=False, blank = False) # tipo de Número de identificación personal
    ...
    gene = models.IntegerField(max_length=1, choices = GENERO, default = 0, null=False, blank = False)  #genero del usuario
...
class usu_inf_contac(models.Model):
    ...
    ls_ha =  models.IntegerField(max_length=1, choices = HORARIO,default = 0, null=False, blank = False) #Listado de Horario de atención [día,hora ini, hora fin]
...
class form_acad(models.Model):
    ...
    tipo_form =  models.IntegerField(max_length=2, choices = TIPO_FORM_CO, default = 0, null=False, blank = False) #tipo de formación ver diccionario TIPO_FORM
    ...
    mod =  models.IntegerField(max_length=1, choices = MODALIDAD, default = 0, null=False, blank = False) # modalidad
...
class usu_inf_acad(models.Model):
    ...
    nivelform =  models.IntegerField(max_length=2, choices = TIPO_FORM_CO, default = 0, null=False, blank = False) # me indica la formacion qu tiene la usuario
...
class curs_dict(models.Model):
    ...
    tipo_form = models.IntegerField(max_length=2, choices = TIPO_FORM_CO, null=False, blank = False, default=0)  #tipo de formación ver diccionario TIPO_FORM
    fch_ini = models.DateField('fecha de inicio', auto_now = False)
    fch_fin = models.DateField('fecha de fin', auto_now = False)
    ...
    mod = models.IntegerField('Modalidad', max_length=1, choices = MODALIDAD, null=False, blank = False, default=0)  # modalidad
    num_est = models.PositiveSmallIntegerField('Cantidad de estudiantes')  #Cantidad de Estudiantes
    dur = models.IntegerField('Cantidad de estudiantes')  #Número total de horas académicas del curso
    nom_curs = models.CharField('Número total de horas académicas del curso', max_length=1, choices = MODALIDAD, null=False, blank = False, default=0)  # modalidad #Nombre del Curso
...
class empleos(models.Model):
    ...
    nal = models.CharField('Pais ', max_length=20, null=False, blank = False)  #país
    ciudad = models.CharField('Ciudad ', max_length=20, null=False, blank = False)
    tipo_contr =  models.IntegerField(max_length=1, choices = TIPO_CONTR_CO, null=False, blank = False, default = 0)
    tit = models.CharField('Titulo obtenido ', max_length=20, null=False, blank = False)  # Título obtenido
...
class usugr_inf_gr(models.Model):
    ...
    id_usugr = models.AutoField(primary_key = True)  # identificador de usuario grupo
    ...
    tipo_gr = models.IntegerField(max_length = 1, choices = TIPO_GR_INV, null = False, blank = False, default = 0) # tipo de grupo, ver diccionario TIPO_GR_INV
    ...
    estado = models.IntegerField(max_length= 2, choices = ESTADO_DLLO_GR, null = False, blank = False, default=0) # Estado de desarrollo del Grupo. Ver diccionario ESTADO_DLLO_GR
    ...
    id_gr_padre = 0 #Identificador del grupo padre si lo tiene, de lo contrario es el valor es cero
...
class usugr_inf_contac(models.Model):
    ...
    ls_hr = models.IntegerField(max_length=1, choices = HORARIO, default =0, null=False, blank = False) #Listado de Horario de reunión semanal[día,hora ini, hora fin]
...
class form_acad_gr(models.Model):
    ...
    tipo_form = models.IntegerField(max_length= 2, choices = TIPO_FORM_GR, null=False, blank = False, default=0) #tipo de formación ver diccionario TIPO_FORM_GR
    fch_ini = models.DateField('Fecha de inicio ', auto_now = False)
    fch_fin = models.DateField('Fecha de fin: ', auto_now = False)
    ...
    mod = models.IntegerField( max_length = 1, choices = MODALIDAD, blank = False, null = False, default = 0) # modalidad
...
class curs_ofer(models.Model):
    ...
    tipo_form_gr = models.IntegerField(max_length=2, choices = TIPO_FORM_GR, null=False, blank = False, default = 0)  #tipo de formación ver diccionario TIPO_FORM_GR
    ...
    mod =  models.IntegerField(max_length=1, choices = MODALIDAD, null=False, blank = False, default=0) # modalidad
...
class usui_inf_inst(models.Model):
    ...
    tipo_nuii = models.IntegerField('Tipo de Número de identificación Institucional', max_length= 1, choices= TIPO_NUII_CO, default= 0, null=False, blank= False) # Tipo de Número de identificación Institucional
    ...
    tipo_inst = models.IntegerField('Tipo de institución o entidad', max_length=1, choices = TIPO_NUIP_CO, default= 0, null=False) # Tipo de institución o entidad. Ver diccionario TIPO_INS
    sector = models.IntegerField('sector de desempeño de la entidad o institución ', max_length=1, choices= SECTOR_ECO, default= 0) # sector de desempeño de la entidad o institución. Ver Diccionario SECTOR_ECO
...
class usui_inf_contac(models.Model):
    ...
    ls_ha = models.IntegerField(max_length= 1, choices= HORARIO, blank=False, default=0, null=False) #Listado de Horario de atención [día,hora ini, hora fin]
...
class usui_inf_acad(models.Model):
    ...
    nivelform = models.IntegerField('Nivel de formacion ', max_length=2 ,choices=TIPO_FORM_CO, default = 0, null=False, blank=False) # me indica la formacion que tiene el usuario
...
class prog_ofer(models.Model):
    ...
    mod = models.IntegerField('MODALIDAD', max_length=1, choices=MODALIDAD, default = 0, null=False, blank=False) # modalidad
...
class usuo_prog_ofer(models.Model): #Listado de id de programas ofertados por la entidad o Institución.
    id_usui = models.ForeignKey(usui, on_delete=models.CASCADE, null=False, blank=False) # identificador unico
    id_usui = models.ForeignKey(prog_ofer, on_delete=models.CASCADE, null=False, blank=False) # identificador unico
...
class conv_inv(models.Model):
    ...
    id_usui = models.ForeignKey(usui,on_delete=models.CASCADE, null=False, blank=False) # Id del usuario institucion .
    val_min = models.PositiveSmallIntegerField('valor minimo: ', default= 5) #valor mínimo
    val_max = models.PositiveSmallIntegerField('valor maximo: ', default= 5) #valor máximo
    ...
    mod = models.IntegerField('Modalidad ', max_length=1, null=False, blank=False, choices=MODALIDAD, default=0) # modalidad
...
class usu(models.Model):
    ...
    passusu  = models.CharField('Contraseña: ', max_length=30, null=False, blank = False)  # contraseña
    id_rol_sis = models.ForeignKey(rol, on_delete=models.CASCADE, null=False, blank =False)  # Identificador del  módulo# Identificador del Rol de Usuario de Sistema
    fch_regi = models.DateField('fecha de fin', auto_now = False) # fecha de registro de usurio
    activo = models.BooleanField('¿Activa o desactiva.?', default=False) # estatus del usuario activo (True) inactivo (False)
...
class genero(models.Model):
    id_genero = models.AutoField(primary_key = True) # Identificador único
    desgenero = models.CharField('Nick: ', max_length=30, null=False, blank = False)  # Nick o identificador de usuario
...
class usu_inf_pers(models.Model):
    id_usu = models.ForeignKey(usu, on_delete=models.CASCADE, null=False, blank =False)  # identificador de usuario
    nuip = models.CharField('número único de identificación personal ', max_length=30, null=False, blank = False)  # número único de identificación personal sin puntos
    tipo_nuip_usu = models.CharField(max_length=1, choices=TIPO_NUIP_CO, default = '0',null=False, blank = False) # tipo de Número de identificación personal
    nombres = models.CharField('Nombres ', max_length=60, null=False, blank = False) # nombres de usuario
    apelllidos = models.CharField('Apellidos ', max_length=60, null=False, blank = False) # apellidos de usuario
    nal = models.CharField('Nacionalidad ', max_length=30, null=False, blank = False) # nacionalidad
    fch_naci = models.DateField('fecha de nacimiento', auto_now = False)   # fecha de nacimiento de usuario
#GENERO=[('Neutro','0'),('Femenino','1'),('Masculino','2'),('Intergénero','3'),('Transgénero','4'),('Sisgénero','5'),('otro','6')]
    id_usu = models.ForeignKey(usu, on_delete=models.CASCADE, null=False, blank =False)  # identificador de usuario
    gene = models.ManyToManyField(genero) #genero del usuario
    ocup = models.CharField('Ocupacion ', max_length=30, null=False, blank = False) # ocupación del usuario
    dir = models.CharField('Direccion ', max_length=100, null=False, blank = False) # direccion de residencia
    discap = models.BooleanField('¿Es una persona en condición de discapacidad?', default=False) # Es una persona en condición de discapacidad
    url_imag = models.URLField('url de la imagen personal.', null=False, blank=False)  # url de la imagen personal.
    zona_hor = models.CharField('Direccion ', max_length=100, null=False, blank = False) #Zona Horario internacional
